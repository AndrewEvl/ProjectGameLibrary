...
CREATE TABLE reviews (id INT AUTO_INCREMENT, review VARCHAR(30), PRIMARY KEY (id));
...
CREATE TABLE forum_theme (id INT AUTO_INCREMENT,reviews_forum_id INT, theme VARCHAR(100), PRIMARY KEY (id,reviews_forum_id), FOREIGN KEY (reviews_forum_id) REFERENCES reviews_forum(id));
